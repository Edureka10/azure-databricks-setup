...
$resourceGroupName = "az-rg-$suffix"
...
$supported_regions = "centralus","eastus","eastus2","northcentralus","northeurope","westeurope","westus", "uksouth", "australiaeast", "japaneast", "centralindia"
